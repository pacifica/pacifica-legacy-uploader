...
heat dir "build" -cg PacificaUploaderGroup -gg -sfrag -dr INSTALLDIR -var var.PacificaUploaderGroup -out pacificauploadergen.wxs

candle pacificauploader.wxs pacificauploadergen.wxs pacificauploaderuigen.wxs -dDaemonUI=go\src\pacificauploaderd\ui -dPacificaUploaderGroup=build -ext WixUtilExtension || goto :error
